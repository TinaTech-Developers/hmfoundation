    ...
    <section className="py-20 bg-gray-50">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <span className="text-[#A7CE44]-600 font-semibold tracking-wide uppercase text-sm">
          ...
          <div className="mx-auto mt-4 w-20 h-1 bg-[#A7CE44]-600 rounded-full"></div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {projects.map((project, i) => (
            <motion.div
              ...
              className="relative bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-2xl shadow-[#A7CE44]-600 transition-all duration-300"
            >
