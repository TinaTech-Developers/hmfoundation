    ...
    <DashboardLayout>
      <div className="flex flex-col gap-6">
        ...
        <button
          ...
          className="px-4 py-2 bg-[#A7CE44]-700 text-white rounded hover:bg-[#A7CE44]-800 transition w-40"
        >
          + Add Program
        </button>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#A7CE44]-700 text-white rounded hover:bg-[#A7CE44]-800 transition"
                  >
                    Add Program
                  </button>
                </div>
